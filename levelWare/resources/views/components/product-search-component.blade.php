    ...
    <div class="w-auto lg:w-auto">
        <form action="{{ route('searchProducts') }}">
            ...
            <div
                ...
                <input type="search"
                    class="form-control relative flex-auto min-w-0 block px-5 py-3 text-base font-normal text-white bg-gray-900/20 bg-clip-padding border border-2 border-solid border-green-700 rounded-l-lg transition ease-in-out m-0 focus:text-white focus:bg-gray-900/40 focus:border-indigo-600 focus:outline-none"
