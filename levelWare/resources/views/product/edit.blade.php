                            ...
                            <div class="mb-4 md:flex md:justify-between">
                                ...
                                <div class="mb-4 md:mr-2 md:mb-0 text-black font-black">
                                  ...
                                  focus:text-gray-700 focus:bg-white focus:border-white focus:shadow-outline"
                                        ...
                                        <option value="1" @if ($producto->tipoPro == 1) selected @endif> Consola
                                        </option>
                                        <option value="2" @if ($producto->tipoPro == 2) selected @endif>Juego
                                        </option>
                                        <option value="3" @if ($producto->tipoPro == 3) selected @endif>Periférico
                                        </option>
                                    </select>
                                </div>
                            </div>
